    ...
    <div>
      ...
      <div className='w-[1080px] mx-auto'>
        ...
        <main className='main'>
          ...
          {/* //Servicios */}
          <section className="pt-16 px-0 pb-8 mx-2 mb-14 " id="services">
            <div className='flex justify-center items-center my-3'>
              <span className='text-green-600 text-xl font-medium'>Servicios</span>
            </div>

            <div className='flex justify-center items-center my-3'>
              <h2 className="text-black dark:text-white text-3xl font-bold tracking-wider my-5">Nuestros increíbles servicios</h2>
            </div>

            <div className="items-center w-[960] mx-11 grid grid-cols-1 md:grid-cols-3 gap-3 mt-8 ">
              {/* //Serviscio 1 */}
              <div className=" flex-col text-center mt-10">
                <div className='grid ml-56 items-center -mb-12'>
                  <svg className=" fill-green-500 justify-self-center" xmlns="http://www.w3.org/2000/svg">
                ...
                <h3 className="text-black dark:text-white text-2xl font-bold tracking-wider m-0">Comida excelente</h3>
                <p className="text-black dark:text-white p-1">Ofrecemos a nuestros clientes servicios de excelente calidad desde hace muchos años, con la mejor y deliciosa comida de la ciudad.</p>
              </div>

              {/* //Serviscio 2 */}
              <div className=" flex-col text-center mt-10">
                <div className='ml-56 items-center w-auto flex justify-center md:ml-32 -mb-12'>
                ...
                <h3 className="text-black dark:text-white text-2xl font-bold tracking-wider my-2">Servicio rápido</h3>
                <p className="text-black dark:text-white p-1">We offer our clients excellent quality services for many years, with the best and delicious food in the city.</p>
              </div>
              ...
              <div className="flex-col text-center mt-10">
                ...
                <h3 className="text-black dark:text-white text-2xl font-bold tracking-wider my-2">Servicio a domicilio</h3>
                <p className="text-black dark:text-white p-1">We offer our clients excellent quality services for many years, with the best and delicious food in the city.</p>
              </div>
            </div>
          </section>
